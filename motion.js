...
const characterDataVlad = {
    ...
    timerId: null,
    move : function() {
        if (this.x < this.screenWidth - this.screenWidth) {
            characterDataVlad.x = document.querySelector("#forest").clientWidth;
        } 
        else {
            this.x += -15;
...
function move() {
    ...
    characterDataBjorn.timerId = setInterval(frame, 100);
}
